...
pl.scatter(allNodesInMap.iloc[:, 1], allNodesInMap.iloc[:, 0], marker='x', color='gray')
pl.scatter(nodesMap.iloc[:, 1], nodesMap.iloc[:, 0], color='red')
pl.scatter(openListMap.iloc[:, 1], openListMap.iloc[:, 0], marker='>', alpha=0.7, color='orange')
pl.scatter(currentNode.iloc[:, 1], currentNode.iloc[:, 0], marker='+', s=80, color='green')
pl.scatter(trajectoryNodes.iloc[:, 1], trajectoryNodes.iloc[:, 0], marker='^', s=75, color='black')
# pl.scatter(startMap.iloc[:, 0], startMap.iloc[:, 1], marker='+')
pl.scatter(targetMap.iloc[:, 1], targetMap.iloc[:, 0], marker='v', color='orange')
pl.show()
